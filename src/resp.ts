...
export type RespContent =
    RespContent.SendMessage
    | RespContent.LatestEvents
    | RespContent.SupportActions
    | RespContent.Status
    | RespContent.Version
    | RespContent.MessageEvent
    | RespContent.UserInfo
    | RespContent.FriendList
    | RespContent.GroupInfo
    | RespContent.GroupList
    | RespContent.FileId
    | RespContent.PrepareFileFragmented
    | RespContent.TransferFileFragmented
    | RespContent.GetFile
    | RespContent.Other
...
export namespace VersionContent {
    export const Default: VersionContent = {
        impl: "Tl_default",
        platform: "empty",
        version: "0.0.0",
        onebot_version: "11",
